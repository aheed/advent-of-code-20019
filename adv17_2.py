...
#total_prog = "R,6,L,10,R,8,R,8,R,12,L,8,L,8,R,6,L,10,R,8,R,8,R,12,L,8,L,8,L,10,R,6,R,6,L8,R,6,L,10,R,8,R,8,R,12,L,8,L,8,L,10,R,6,R,6,L,8,R,6,L,10,R,8,L,10,R,6,R,6,L,8"
main_prog = "A,B,A,B,C,A,B,C,A,C"
a_prog = "R,6,L,10,R,8"
b_prog = "R,8,R,12,L,8,L,8"
c_prog = "L,10,R,6,R,6,L,8"

total_prog = main_prog + "\n" + a_prog + "\n" + b_prog + "\n" + c_prog + "\nn\n"


total_prog_list = [ord(character) for character in total_prog]
print(total_prog)
print(total_prog_list)

mem[0] = 2
intcomputer = {'prog': mem.copy(), 'outputs': [], 'pc': 0, 'relbase': 0}
intcomputer['inputs'] = QueueInputSource(total_prog_list)
execute(intcomputer['prog'], intcomputer['inputs'], intcomputer['outputs'], intcomputer['relbase'])

print(intcomputer['outputs'])
