...
main_prog_list = [ord(character) for character in main_prog]
print(main_prog)
print(main_prog_list)


intcomputer = {'prog': mem.copy(), 'outputs': [], 'pc': 0, 'relbase': 0}
intcomputer['inputs'] = QueueInputSource(main_prog_list)
execute(intcomputer['prog'], intcomputer['inputs'], intcomputer['outputs'], intcomputer['relbase'])

print(intcomputer['outputs'])

output_string = "".join([chr(character) for character in intcomputer['outputs'] if character < 256])
print(output_string)
print(intcomputer['outputs'].pop())
